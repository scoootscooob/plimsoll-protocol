...
LLM routes intended JSON-RPC or REST payloads to Plimsoll, not directly to
the target API/blockchain RPC. Plimsoll evaluates, optionally signs via the
vault, and either forwards or blocks.

Deploy as::

    uvicorn plimsoll.proxy.interceptor:app --host 127.0.0.1 --port 8545
