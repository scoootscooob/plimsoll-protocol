...
/// @title PlimsollAttestation (PoBR) Test Suite
contract PlimsollAttestationTest is Test {
    PlimsollAttestation attestation;
    ...
    function setUp() public {
        attestation = new PlimsollAttestation();
    }
    ...
    function test_attest_stores_all_fields() public {
        ...
        PlimsollAttestation.Attestation memory a = attestation.getAttestation(vault1);
    ...
    function test_attest_emits_event() public {
        ...
        emit PlimsollAttestation.AttestationCreated(vault1, vaultOwner, 500, 10 ether);
        attestation.attest(vault1, vaultOwner, 500, 10 ether, 5, true, true, true);
    }
    ...
    function test_update_emits_event() public {
        ...
        emit PlimsollAttestation.AttestationUpdated(vault1);
        attestation.update(vault1, 1000, 20 ether, 10);
    }
    ...
    function test_revoke_emits_event() public {
        ...
        emit PlimsollAttestation.AttestationRevoked(vault1, "Test revoke");
    ...
    function test_multiple_vaults_independent() public {
        ...
        PlimsollAttestation.Attestation memory a1 = attestation.getAttestation(vault1);
        PlimsollAttestation.Attestation memory a2 = attestation.getAttestation(vault2);
