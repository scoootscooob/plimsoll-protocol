...
/**
 * @title AegisAttestation — Proof of Bounded Risk (PoBR)
 * @notice On-chain registry of Aegis-governed vaults and their risk parameters.
 *
 * When a human configures an AegisVault, this contract mints an attestation:
 ...
 */
contract AegisAttestation {
    address public registrar;   // Aegis protocol authority
