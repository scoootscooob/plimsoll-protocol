...
Defence:
    Before signing any transaction, Aegis sends the payload to an EVM
    ...
    → Aegis blocks the transaction.

The simulation backend is a **pluggable callable**, so Aegis itself
