"""
Python SDK bridge for the Aegis V5 Smart Vault (ERC-4337).

Manages the on-chain AegisVault: deposit, session keys, execution,
physics module configuration, and PoBR attestation queries.

    from aegis.vault import SmartVaultClient, SmartVaultConfig
...
# ABI fragments for AegisVault interactions
VAULT_ABI = [
    {
        "name": "deposit",
        "type": "function",
...
class SmartVaultClient:
    """Python SDK for managing an on-chain AegisVault.
